...
document.querySelector('#cart-btn-2').onclick = function () {
  cartItem.classList.toggle('active');
  searchForm.classList.remove('active');
}; // нажатие кнопки оплатить


var btnPaid = document.querySelector('.btn-paid');

document.querySelector('#btn-paid').onclick = function () {
...
var input = document.querySelector('.form-input'); // кнопки отправить
...
//# sourceMappingURL=/Итоговый%20проект.e31bb0bc.js.map